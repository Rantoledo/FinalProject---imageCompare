...
SP_LOGGER_MSG TheChecker(const char* msg, const char* file,
...
SP_LOGGER_MSG spLoggerPrintError(const char* msg, const char* file,
	...
	SP_LOGGER_MSG check = TheChecker(msg, file, function, line);
	if (check != SP_LOGGER_SUCCESS){
		return check;
	}
...
SP_LOGGER_MSG spLoggerPrintInfo(const char* msg){
	...
	SP_LOGGER_MSG check = TheChecker(msg, __FILE__, __func__, __LINE__);
	if (check != SP_LOGGER_SUCCESS){
		return check;
	}
